-- ════════════════════════════════════════════════════════════════════════════════
-- [flux].lua  —  Menu & Lib-Orchestrierung (einzige vom User zu ladende Datei)
-- _VERSION 1.0.0  ·  Nachfolger von inspire-menu.lua
-- ════════════════════════════════════════════════════════════════════════════════
...
-- (keeps the console clean in normal use).
...
-- Menu
-- ════════════════════════════════════════════════════════════════════════════════
-- TODO (v1.0.1): build the Assist menu (General / Bind Config / Advanced / Visualizer),
--                expose _G.aim_menu.
...
-- Target Selector
-- ════════════════════════════════════════════════════════════════════════════════
-- TODO (v1.0.1): [flux].lua side of the target-selector binding
--                (T.register_bind / T.set_active / T.set_master each tick).


-- ════════════════════════════════════════════════════════════════════════════════
-- Aimbot
-- ════════════════════════════════════════════════════════════════════════════════
-- TODO (v1.0.1): [flux].lua side of the aimbot / fire orchestration.
