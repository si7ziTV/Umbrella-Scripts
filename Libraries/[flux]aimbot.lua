-- ════════════════════════════════════════════════════════════════════════════════
-- [flux]aimbot.lua  —  Aimbot + Feuer-Lib (Magnet + Legitbot + PSilent/AutoFire)
-- _VERSION 1.0.0  ·  Nachfolger von inspire-aimbot.lua + inspire-fire.lua (gemerged)
-- ════════════════════════════════════════════════════════════════════════════════
...
-- Aimbot
-- ════════════════════════════════════════════════════════════════════════════════
-- TODO (v1.0.1): Magnet + Legitbot (visible channel, expose _G.aimbot_state)
--                + Fire orchestrator (PSilent, AutoFire, move_fix) — single acquire+fire caller.
