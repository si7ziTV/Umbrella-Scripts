-- ════════════════════════════════════════════════════════════════════════════════
-- [flux]targetselector.lua — _VERSION 1.0.2
-- ════════════════════════════════════════════════════════════════════════════════
...
--			files); target-selection logic deferred to a later phase
...
-- ════════════════════════════════════════════════════════════════════════════════
-- Target Selector (logic deferred)
-- ════════════════════════════════════════════════════════════════════════════════
-- Target-acquisition, filtering/scoring, PSilent hand-off and auto-fire move in with a
-- later phase. The menu placeholders it will drive (Targets, Priority slots, Ignore,
-- Method, Lock, Backtrack) already live in [flux]menu.lua; this lib will read them via
-- the flux_menu (FM) handle once its logic lands.
